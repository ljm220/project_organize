...
<!-- 		북마크 끝 -->
		...
		<c:choose>
			<c:when test="${ship.usrNum == sessionId}">
				<p class="fw-bold mb-2" style="color: #0000008c">${ship.shipTitle}나는관리자</p>
			</c:when>
			<c:otherwise>
	...
	<ul class="nav nav-pills flex-column mb-auto">
		...
		<li><a id="side-album" href="/ship/${ship.shipNum}/album" class="btn-outline-secondary nav-link link-dark"><i class="bi bi-camera me-3"></i>사진첩 </a></li>
		<li><a id="side-calendar" href="/ship/${ship.shipNum}/calendar" class="btn-outline-secondary nav-link link-dark"><i class="bi bi-calendar2-day me-3"></i>일정 </a></li>
		<li><a id="side-attachmentList" href="/ship/${ship.shipNum}/attachmentList" class="btn-outline-secondary nav-link link-dark"><i class="bi bi-folder2-open me-3"></i>첨부 </a></li>
		<li><a id="side-crewList" href="/ship/${ship.shipNum}/crewList" class="btn-outline-secondary nav-link link-dark"><i class="bi bi-people-fill me-3"></i>크루원 </a></li>
