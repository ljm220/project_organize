				...
				<main class="col-9 p-0" style="overflow: visible">
					<div class="col-10 p-0" style="background-color: white;">
						...
						<ul class="nav nav-pills flex-row mb-auto">
							...
							<a href="/mySettingHelp/5" class="nav-link" style="color:white"> 
					...
					<div class="col-10 p-0" style="background-color: white;">
						...
						<div class="row p-3 border border-black"
							style="float: none; margin: 0 auto; font-size: 10pt">멤버를
							소환하고 싶어요.</div>
						<div class="row p-3 border border-black"
							style="float: none; margin: 0 auto; font-size: 10pt">멤버들의
							최근 접속일(방문일)을 알고 싶어요.</div>
						<div class="row p-3 border border-black"
							style="float: none; margin: 0 auto; font-size: 10pt">멤버를
							강제탈퇴/차단 하고 싶어요.</div>
						<div class="row p-3 border border-black"
							style="float: none; margin: 0 auto; font-size: 10pt">자꾸 이상한
							사람들이 ship에 가입해요. 가입을 막아주세요.</div>
					</div>
				</main>
			</div>
		</div>
